...
// Read CIFAR-10 Binary Files for Binary Classification (Classes 0 and 1)
...
int main() {
    ...
    std::string trainBatchFile = "C:/Users/hrith/Downloads/cifar-10-binary/cifar-10-batches-bin/data_batch_1.bin"; // Replace with your path
    ...
    std::string testBatchFile = "C:/Users/hrith/Downloads/cifar-10-binary/cifar-10-batches-bin/test_batch.bin"; // Replace with your path
